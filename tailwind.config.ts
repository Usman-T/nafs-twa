    ...
    extend: {
      colors: {
        ...
        dark: {
          ...
          bg1: "#1e1e1e", // Card background
          bg2: "#2e2e2e", // Borders, dividers
          bg3: "#383838", // Hover states
          fg0: "#e0e0e0", // Primary text
          fg1: "#b0b0b0", // Secondary text
          fg2: "#909090", // Muted text
          orange: {
            DEFAULT: "#b35309", // Darker orange
            light: "#d65d0e", // Muted orange
          },
        },
      },
      borderRadius: {
      ...
      boxShadow: {
        "dark-glow": "0 4px 20px -2px rgba(0, 0, 0, 0.5)",
        "dark-inner": "inset 0 2px 4px 0 rgba(0, 0, 0, 0.3)",
        "orange-glow": "0 0 15px rgba(179, 83, 9, 0.5)",
      },
      backgroundImage: {
